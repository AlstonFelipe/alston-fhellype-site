    ...
    <div className="site-shell">
      ...
      <footer id="contato" className="site-footer">
        <div className="section-wrap footer-top">
          ...
          <div className="footer-links"><a href="mailto:contato@alstonfhellype.com.br"><Mail size={15} /> E-mail</a><a href="https://www.amazon.com.br/s?k=Alston+Fhellype" target="_blank" rel="noreferrer"><BookOpen size={15} /> Amazon</a><a href="#top"><Instagram size={15} /> Instagram</a></div>
        </div>
